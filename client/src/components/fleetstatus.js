  ...
  return (
    <div style={{backgroundColor: '3b3a38'}}>
      {acft.map(tail => (
        ...
        <Accordion expanded={expanded === tail.tailNumber} onChange={handleChange(tail.tailNumber)} sx={{backgroundColor: '#1A2930', color: 'white', paddingRight: '10px'}}> 
          <AccordionSummary
          ...
          >
            ...
            <Card elevation={0} sx={{ width: '25%', flexShrink: 0, backgroundColor: '#1A2930', color: 'white'}}>
